    ...
    <div className="min-h-screen flex items-center justify-center bg-background p-4">
      <Card className="w-full max-w-md glow-none">
        <div className="text-center mb-8">
          ...
          <p className="text-text-muted">Masuk untuk memantau perangkatmu</p>
        </div>
        <form onSubmit={handleEmailLogin} className="space-y-4">
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-3 bg-surface border border-border rounded-lg text-text focus:outline-none focus:border-primary"
